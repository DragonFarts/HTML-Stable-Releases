...
function drawParticle(particle, time) {
    ...
    var outlineColorIndex = (particle.colorIndex + Math.floor((1 + Math.sin(time / 1000)) * currentPalette.length / 2)) % currentPalette.length;
    var fillColorIndex = (particle.colorIndex + Math.floor((1 + Math.sin(time / 2000)) * currentPalette.length / 2)) % currentPalette.length;
    var fillColor = currentPalette[fillColorIndex];
    var outlineColor = currentPalette[outlineColorIndex];
